...
[lobstermail](../README.md) / LobsterMailError

# Class: LobsterMailError

Defined in: packages/sdk/src/errors.ts:2
...
- [`InsufficientTierError`](InsufficientTierError.md)
...
> **new LobsterMailError**(`message`, `code`, `statusCode?`, `requestId?`): `LobsterMailError`

Defined in: packages/sdk/src/errors.ts:7
